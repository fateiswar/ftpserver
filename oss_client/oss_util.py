...
class GetAllObjects:
    ...
    def get_object_in_bucket(self, oss, bucket="", marker="", prefix="", delimiter=""):
        object_list = []
        dir_list = []
        maxkeys = 1000
        try:
    ...
    def get_all_object_in_bucket(self, oss, bucket="", marker="", prefix="", delimiter=""):
        marker2 = ""
        while True:
            (object_list, dir_list, marker) = self.get_object_in_bucket(oss, bucket, marker2, prefix, delimiter)
            marker2 = marker
